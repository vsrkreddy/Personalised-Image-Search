...
%>
				...
				<div class="author">Posted in: <a href="#">Photography</a> <%=rs1.getString("date")%></div>
        ...
        <div class="sidebar">
          <div id="welcome-guest">
            ...
            <table height="150">
				...
				<tr>
					<td>Name:</td>
					<td>&nbsp;<input type="text" value="<%=rs1.getString(1)%>" name="name"></td>
				</tr>
				<tr>
					<td>Gender:</td>
					<td>&nbsp;<input type="text" value="<%=rs1.getString(3)%>" name="gender"></td>
				</tr>
				
				<tr>
					<td>About:</td>
					<td>&nbsp;<input type="text" value="<%=rs1.getString(4)%>" name="define"></td>
				</tr>

				<tr>
					<td></td>
					<td><input type="submit" value="Update" name="update" class="submit_bg"></td>
				</tr>
