...
ArrayList list = new ArrayList();
		...
		String file=null;
		String tag=null,title=null,visible=null,description=null,image=null,name=null,email=null,id=null;
	...
	while (files.hasMoreElements()) 
	{
       ...
       if(f == 0)
		...
		else if(f == 1)
		{
			...
			if(x!=0)
			{
				response.sendRedirect("upload1.jsp?message=success");
			}
			else
			{
				response.sendRedirect("upload1.jsp?message=fail");
			}
